...
for band in bands:
    ...
    for j, beta in enumerate(betas):
        ...
        print("predictions done with band: " + band + " and beta: " + str(beta))

print("all predictions done")

accuracy_table.to_csv(path_or_buf=r'../../Data3/Hamid_ML4Science_ALE/accuracy_table_log_all_epochs_GS.csv')
