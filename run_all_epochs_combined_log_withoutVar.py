...
betas = [ 0.5, 0.55, 0.6,0.6499999999999999, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95, 1.]
...
accuracy_table.to_csv(path_or_buf=r'../../../Data3/Hamid_ML4Science_ALE/SVMwithoutVar/accuracywithoutVar_table_log_all_epochs_gammaband_allrange.csv')
