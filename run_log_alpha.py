...
accuracy_table.to_csv(path_or_buf=r'../../Data3/Hamid_ML4Science_ALE/SVM_updated_GS/accuracy_table_log_alpha.csv')
print("accuracy table alpha band successfully saved")
