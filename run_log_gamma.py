...
accuracy_table.to_csv(path_or_buf=r'../../Data3/Hamid_ML4Science_ALE/SVM_updated_GS/accuracy_table_log_gamma.csv')
print("accuracy table gamma band successfully saved")
